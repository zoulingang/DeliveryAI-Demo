  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-rice-100 paper-noise dark:bg-charcoal-900">
      ...
      <div className="relative mx-auto w-full max-w-md px-5 py-10">
        <section className="animate-rise overflow-hidden rounded-3xl border border-white/80 bg-white/90 shadow-float backdrop-blur dark:border-white/10 dark:bg-charcoal-700/90">
          {/* 门店图片 */}
          ...
          <div className="px-6 py-8 text-center">
            ...
            <h1 className="text-3xl font-extrabold leading-tight text-charcoal-900 dark:text-rice-100 sm:text-4xl">
              {t('welcome.title')}
            </h1>
            <p className="mt-3 flex items-center justify-center gap-1.5 text-base font-semibold text-charcoal-500 dark:text-rice-200/60">
